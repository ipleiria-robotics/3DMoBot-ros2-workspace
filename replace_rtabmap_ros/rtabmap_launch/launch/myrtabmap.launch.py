...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Stereo related topics, infra2 is on the right
        DeclareLaunchArgument('stereo_namespace',        default_value='/stereo_camera', description=''),
        DeclareLaunchArgument('left_image_topic',        default_value=[LaunchConfiguration('stereo_namespace'), '/camera/camera/infra1/image_rect_raw'], description=''),
        DeclareLaunchArgument('right_image_topic',       default_value=[LaunchConfiguration('stereo_namespace'), '/camera/camera/infra2/image_rect_raw'], description='Use grayscale image for efficiency'),
        DeclareLaunchArgument('left_camera_info_topic',  default_value=[LaunchConfiguration('stereo_namespace'), '/camera/camera/infra1/camera_info'], description=''),
        DeclareLaunchArgument('right_camera_info_topic', default_value=[LaunchConfiguration('stereo_namespace'), '/camera/camera/infra2/camera_info'], description=''),
        ...
        DeclareLaunchArgument('scan_topic',           default_value='/ouster/scan',       description=''),
        DeclareLaunchArgument('subscribe_scan_cloud', default_value='false',       description=''),
        DeclareLaunchArgument('scan_cloud_topic',     default_value='/ouster/points', description=''),
